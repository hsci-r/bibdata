...
#params=list(dataset_name= "ERB",dataset="../data/cnb/cnb.parquet",field_descriptions="../data/schema-info/pica_fields.tsv",subfield_descriptions="../data/schema-info/pica_subfields.tsv", min_year=1400,max_year=1800, date_modified='')
start.time <- Sys.time()
library(tidyverse)
library(gt)
library(glue)
...
d |>
  ...
  fmt_percent(prop) |>
  opt_interactive(use_search=TRUE, use_filters=FALSE, use_pagination = FALSE)
```
