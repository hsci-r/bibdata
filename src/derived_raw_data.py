...
wd_names = cast(nw.LazyFrame[DuckDBPyRelation], None)
stable_ids = cast(nw.LazyFrame[DuckDBPyRelation], None)
id_mappings = cast(nw.LazyFrame[DuckDBPyRelation], None)
...
__all__ = ["wd_collective_agent_types", "wd_collective_agents", "wd_geolocatable_entities", "wd_geolocatable_entity_types", "wd_people", "wd_people_types", "wd_preflabel", "wd_names", "stable_ids", "id_mappings"]